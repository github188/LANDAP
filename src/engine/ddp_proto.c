...
/* ddp_proto_upgrade.c */
INT4 ddp_proto_upgrade_fw(struct ddp_interface* ifs, struct ddp_header* inHdr, struct ddp_message* inMsg);
INT4 ddp_proto_upgrade_cfg_backup(struct ddp_interface* ifs, struct ddp_header* inHdr, struct ddp_message* inMsg);
INT4 ddp_proto_upgrade_cfg_restore(struct ddp_interface* ifs, struct ddp_header* inHdr, struct ddp_message* inMsg);

/* ddp_proto_switch.c */
INT4 i4fnDDP_proto_switch_vlan_cfg(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);
INT4 i4fnDDP_proto_switch_vlan_get(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);
INT4 i4fnDDP_proto_switch_asv_cfg(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);
INT4 i4fnDDP_proto_switch_asv_get(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);
INT4 i4fnDDP_proto_switch_asv_usr_mac_cfg(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);
INT4 i4fnDDP_proto_switch_asv_usr_mac_get(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);
INT4 i4fnDDP_proto_switch_get_port_number(struct ddp_interface* pstDDP_ifs, struct ddp_header* pstDDP_Hdr_in, struct ddp_message* pstDDP_Msg_in);

/* ddp_proto_ap.c */
INT4 ddp_proto_set_multi_ssid(struct ddp_interface* ifs, struct ddp_header* inHdr, struct ddp_message* inMsg);
INT4 ddp_proto_get_multi_ssid(struct ddp_interface* ifs, struct ddp_header* inHdr, struct ddp_message* inMsg);
    ...
    switch (inHdr.opcode) {
        ...
        case DDP_OP_DISCOVERY:
            if (ddp_proto_check_op_enable(DDP_OP_DISCOVERY) == DDP_OP_ENABLE) {
                retVal = ddp_proto_discovery(ifs, &inHdr, inMsg);
            }
            break;
